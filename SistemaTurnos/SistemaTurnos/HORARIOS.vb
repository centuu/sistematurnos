...
Public Class HORARIOS
    ...
    Private Sub GridView1_EditFormPrepared(sender As Object, e As EditFormPreparedEventArgs) Handles GridView1.EditFormPrepared
        Try
            If Not editar Then
                Dim id As Integer = Session1.ExecuteScalar("SELECT MAX(idHorario) FROM Horarios") + 1
                GridView1.SetFocusedRowCellValue(colidHorario, id)
            End If
    ...
    Private Sub BorrarRegistro()
        Try
            ...
            If MsgBox("¿Desea eliminar el horario?", vbYesNo + vbQuestion, "Eliminar") = vbYes Then
                Session1.ExecuteNonQuery("DELETE FROM Horarios WHERE idHorario = " & GridView1.GetFocusedRowCellValue(colidHorario))
